...
- [3. Using the Isolated GPU as the main GPU with Looking Glass](#3-using-the-isolated-gpu-as-the-main-gpu-with-looking-glass-)
  ...
  - [3.5. Setting uo Looking Glass on VM](#35-setting-up-looking-glass-on-vm-)
...
- In this guide, we will see how to create a windows VM with QEMU/KVM and doing a GPU passthrough by using **vfio**.
